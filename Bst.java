...
public class Bst 
{
	...
	public static void main(String[] args) 
	{
		...
		Bst tr = new Bst();
		System.out.println("Enter elements for tree(comma separated): ");
		String j = sc.next();
		String[] arr;
		arr = j.split(",");
		Node r2 = r;
		...
		while (end != 1) 
		{
			...
			System.out.println("Press 1 Insert in BST ");
			System.out.println("Press 2 Search an element ");
			System.out.println("Press 3 Delete an element ");
			System.out.println("Press 4 Inorder of BST ");
			System.out.println("Press 5 Preorder of BST ");
			System.out.println("Press 6 Postorder of BST ");
